...
const Loaders = (props) => {
      ...
      switch (error) {
        case 404:
          setErrorText([
            ...
            "https://innovationmanagement.se/wp-content/uploads/2015/07/sensing-exploring-uncharted-territory.png",
          ]);
          break;
        case 401:
          setErrorText([
            "401",
            "Authorizathion is required to have access",
            "https://p0.piqsels.com/preview/407/779/638/padlock-window-bars-bars-closed.jpg",
          ]);
          break;
        case 403:
          setErrorText([
  ...
  return (
    <div
      className="full-page p-2 p-md-5 "
      style={
        errorText && {
          backgroundImage: `url("${errorText[2]}")`,
      ...
      {!error ? (
        ...
        <div className="errors w-75 m-auto">
          <img
            ...
            style={{ filter: errorText[3] && "invert(1)" }}
            height="50"
          />
          <div
            className={`mt-5 d-flex flex-column text-center ${errorText[3]}`}
          >
            ...
            <Link to="/home">
              <Button
                variant={errorText[3] ? "contained" : "outlined"}
                size="large"
                className="font-bolder"
                color={errorText[3] ? "contained" : "primary"}
              >
                Take me home
              </Button>
            </Link>
